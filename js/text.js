...
let thirdChapter = createAndPushChapter('Chapter 3', 'Confrontation', 'url(../img/background/textmessagebg.png)');
...
let fourthChapter = createAndPushChapter('Chapter 4', 'Strangers', 'url(../img/background/strangersbg.png)');
